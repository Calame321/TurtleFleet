...
local all_files = {
  "test/startup.lua",
  "test/turtlesleet/managers/t_log_manager.lua",
  "test/turtlesleet/managers/t_settings_manager.lua",
  "test/turtlesleet/models/log.lua",
  "test/turtlesleet/models/queue.lua",
  "test/turtlesleet/turtle/advanced_turtle.lua",
  "test/turtlesleet/turtle/jobs/miner.lua",
  "test/turtlesleet/ui/components/back_button.lua",
  "test/turtlesleet/ui/components/class.lua",
  "test/turtlesleet/ui/components/component_base.lua",
  "test/turtlesleet/ui/components/input.lua",
  "test/turtlesleet/ui/components/inventory_grid.lua",
  "test/turtlesleet/ui/components/item_list.lua",
  "test/turtlesleet/ui/components/label.lua",
  "test/turtlesleet/ui/components/list_input.lua",
  "test/turtlesleet/ui/components/object.lua",
  "test/turtlesleet/ui/components/page.lua",
  "test/turtlesleet/ui/components/panel.lua",
  "test/turtlesleet/ui/components/selector.lua",
  "test/turtlesleet/ui/components/text_input.lua",
  "test/turtlesleet/ui/components/title.lua",
  "test/turtlesleet/ui/pages/main_menu_page.lua",
  "test/turtlesleet/ui/pages/builder/builder_page.lua",
  "test/turtlesleet/ui/pages/builder/farms_page.lua",
  "test/turtlesleet/ui/pages/builder/farms/cane_farm_page.lua",
  "test/turtlesleet/ui/pages/configurations/configurations_page.lua",
  "test/turtlesleet/ui/pages/configurations/current_config.lua",
  "test/turtlesleet/ui/pages/configurations/forbidden_blocks_page.lua",
  "test/turtlesleet/ui/pages/configurations/fuel_config_page.lua",
  "test/turtlesleet/ui/pages/configurations/set_storage_page.lua",
  "test/turtlesleet/ui/pages/fleet_mode/fleet_digout_page.lua",
  "test/turtlesleet/ui/pages/fleet_mode/fleet_flatten_page.lua",
  "test/turtlesleet/ui/pages/fleet_mode/fleet_manager_page.lua",
  "test/turtlesleet/ui/pages/fleet_mode/fleet_page.lua",
  "test/turtlesleet/ui/pages/miner/branch_mine_page.lua",
  "test/turtlesleet/ui/pages/miner/digout_page.lua",
  "test/turtlesleet/ui/pages/miner/flatten_chunk_page.lua",
  "test/turtlesleet/ui/pages/miner/miner_page.lua",
  "test/turtlesleet/ui/pages/miner/vein_mine_page.lua",
  "test/turtlesleet/ui/pages/stations/cooking_page.lua",
  "test/turtlesleet/ui/pages/stations/stations_page.lua",
  "test/turtlesleet/ui/pages/stations/tree_farm_page.lua",
  "test/turtlesleet/ui/pages/stations/farming/farming_page.lua",
  "test/turtlesleet/ui/pages/stations/farming/rice_page.lua",
  "test/turtlesleet/ui/pages/stations/farming/sugarcane_page.lua",
  "test/turtlesleet/utils/table_extension.lua",
}
