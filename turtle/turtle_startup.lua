...
main_menu.top_menu_bar.add_sub_item( "turtle", "canefarm"    , "0.Cane Farm"    , "0", function() cane_farm() end )
main_menu.top_menu_bar.add_sub_item( "turtle", "treefarm"    , "1.Tree Farm"    , "1", function() treefarm:start_tree_farm() end )
main_menu.top_menu_bar.add_sub_item( "turtle", "veinmine"    , "2.Vein Mine"    , "2", function() miner:vein_mine( "forward", "micenraft:coal_ore" ) end )
main_menu.top_menu_bar.add_sub_item( "turtle", "digout"      , "3.Dig Out"      , "3", function() miner:dig_out_start( 3, 3 ) end )
main_menu.top_menu_bar.add_sub_item( "turtle", "placefloor"  , "4.Place Floor"  , "4", function() builder:place_floor( args[ 2 ] ) end )
main_menu.top_menu_bar.add_sub_item( "turtle", "placewall"   , "5.Place Wall"   , "5", function() builder:place_wall() end )
main_menu.top_menu_bar.add_sub_item( "turtle", "minebranch"  , "6.Mine Branch"  , "6", function() miner:mine_branch() end )
main_menu.top_menu_bar.add_sub_item( "turtle", "flatchunk"   , "7.Flatten Chunk", "7", function() flaten_chunks( 1 ) end )
main_menu.top_menu_bar.add_sub_item( "turtle", "cooking"     , "8.Start Cooking", "8", function() cooker:start_cooking() end )
main_menu.top_menu_bar.add_sub_item( "turtle", "branchmining", "9.Branch Mining", "9", function() miner:branch_mining() end )
